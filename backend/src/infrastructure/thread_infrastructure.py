...
class ThreadInfrastructure:
    ...
    def fetch_all_threads_sorted_by_comment_count(self):
        """
        全てのスレッドをコメント数の降順で取得する関数
        :return: スレッドのリスト
        """
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail="データベースからスレッドを取得できませんでした。fetch_all_threads_sorted_by_comment_count: " + str(e))
        return res
